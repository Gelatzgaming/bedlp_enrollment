        ...
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <?php if ($_SESSION['role'] == "Master Key") {
                    ...
                    <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#subj-bed" role="button"
                    aria-expanded="false" aria-controls="subj-bed">
                    <i class="fa fa-binoculars"></i>
                    <span class="item-name">Primary - Junior</span>
                    <i class="right-icon">
                        <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                ...
                <ul class="sub-nav collapse" id="subj-bed" data-bs-parent="#subj-bed">
                    <li class="nav-item">
                        <a class="nav-link " href="../bed-curr/BEDCur.php">
                            ...
                            <i class="sidenav-mini-icon"> H </i>
                            <span class="item-name"> Basic Education </span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#subj-shs" role="button"
                    aria-expanded="false" aria-controls="subj-shs">
                    <i class="fa fa-binoculars"></i>
                    <span class="item-name">Senior High</span>
                    <i class="right-icon">
                        <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <?php
                    ...
                    <ul class="sub-nav collapse" id="maintenance" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="../bed-choices/list.choices.php">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                ...
                                <i class="sidenav-mini-icon"> H </i>
                                <span class="item-name"> Choices List </span>
                            </a>
                        </li>
                    </ul>
                    </li>
                    ...
                    <ul class="sub-nav collapse" id="data-ent" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="../bed-choices/add.choices.php">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                ...
                                <i class="sidenav-mini-icon"> H </i>
                                <span class="item-name"> Add Choices </span>
                            </a>
                        </li>
                    </ul>
                    </li>
                ...
                <?php
                    ...
                    <a class="nav-link" data-bs-toggle="collapse" href="#offersub1" role="button" aria-expanded="false"
                        ...
                        <i class="fa fa-calendar"></i>
                        <span class="item-name"><small>Enrollment Update</small></span>
                        <i class="right-icon">
                            <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <ul class="sub-nav collapse" id="offersub1" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="../bed-enrollment-update/set.target.php">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                ...
                                <i class="sidenav-mini-icon"> H </i>
                                <span class="item-name"> Set Target </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../bed-enrollment-update/add.enrollment.update.php">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                ...
                                <i class="sidenav-mini-icon"> H </i>
                                <span class="item-name"> Add Daily Update </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../bed-enrollment-update/list.enrollment.update.php">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                ...
                                <i class="sidenav-mini-icon"> H </i>
                                <span class="item-name"> Daily Update List</span>
                            </a>
                        </li>
                    </ul>
                </li>                    
