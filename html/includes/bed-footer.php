<footer class="footer pb-md-o">


    <!-- wpow 
    -->
    <div class="row justify-content-center">
        <div class="card text-white bg-danger mx-4" style="height: 5%; width:28%;">
            <div class="card-body justify-content-center">
                <div class="row">
                    ...
                    <div class="col">
                        <h6 style="color:white;">Academic Year <br>
        ...
        WHERE student_id = '$stud_id' AND semester_id = '0' AND ay.academic_year = '$_SESSION[active_acadyears]'") or die(mysqli_error($conn));
            ...
            <div class="card text-white bg-danger mx-4" style="height: 5%; width:28%;">
                <div class="card-body justify-content-center">
                    <div class="row">
                        <div class="col-auto">
                            <i class="fa fa-flag" style="font-size: 50px;"></i>
                        </div>
                        <div class="col">
                            <h6 style="color:white;">Semester <br>
