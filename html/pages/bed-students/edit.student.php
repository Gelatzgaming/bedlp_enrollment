                  ...
                  <div class="card-body" style="color:black;">
                     ...
                     <?php
                             ...
                             <div class="col-md-6 mb-3">
                              ...
                              <input type="text" class="form-control" id="example-text-input" name="studentid" placeholder="Student ID" value="<?php echo $row['student_id']; ?>" required>
                           </div>
                           <div class="col-md-6 mb-3">
                              <label class="form-label" for="example-text-input">Learner Reference Number</label>
                              <input type="text" class="form-control" id="example-text-input" name="lrn" placeholder="Learner Reference Number" value="<?php echo $row['lrn']; ?>" required>
                           </div>
