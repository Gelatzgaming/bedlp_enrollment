                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label" for="example-text-input">Date of
                                                        Birth</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="date_birth" placeholder="Date of Birth"
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label"
                                                        for="example-text-input">Nationality</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="acr" placeholder="ACR Number"
                                                        value="<?php echo $row['acr']; ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label" for="example-text-input">Cellphone
                                                        No.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="cellphone" placeholder="Cellphone Number"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Name of
                                                        Father</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="fname" placeholder="Name of Father"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Name of
                                                        Mother</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="mname" placeholder="Name of Mother"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Age</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="fage" placeholder="(Father) Age"
                                                        value="<?php echo $row['fage']; ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Age</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="mage" placeholder="(Mother) Age"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Email
                                                        Address</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="femail" placeholder="(Father) Email Address"
                                                        value="<?php echo $row['femail']; ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Email
                                                        Address</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="memail" placeholder="(Mother) Email Address"
                                                        value="<?php echo $row['memail']; ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Landline
                                                        No.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="flandline" placeholder="(Father) Landline Number"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Landline
                                                        No.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="mlandline" placeholder="(Mother) Landline Number"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Contact
                                                        No.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="fcontact" placeholder="(Father) Contact Number"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Contact
                                                        No.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="mcontact" placeholder="(Mother) Contact Number"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Education
                                                        Attainment</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="feduc_attain" placeholder="(Father) Education Attainment"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Education
                                                        Attainment</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="meduc_attain" placeholder="(Mother) Education Attainment"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Last School
                                                        Attended</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="flast_sch_att" placeholder="(Father) Last School Attended"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Last School
                                                        Attended</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="mlast_sch_att" placeholder="(Mother) Last School Attended"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label"
                                                        for="example-text-input">Occupation</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="focc" placeholder="(Father) Occupation"
                                                        value="<?php echo $row['focc']; ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label"
                                                        for="example-text-input">Occupation</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="mocc" placeholder="(Mother) Occupation"
                                                        value="<?php echo $row['mocc']; ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Business
                                                        Add.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="fbus_ad" placeholder="(Father) Business Address"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Business
                                                        Add.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="mbus_ad" placeholder="(Mother) Business Address"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Office Phone
                                                        No.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="fof_ph_no" placeholder="(Father) Office Phone Number"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">Office Phone
                                                        No.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="mof_ph_no" placeholder="(Mother) Office Phone Number"
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-5 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="example-text-input"
                                                        name="fmonth_inc" placeholder="(Father) Monthly Income"
                                                ...
                                                <div class="col-md-5 mb-3">
                                                    <label class="form-label" for="example-text-input">Monthly
                                                        Income</label>
                                                    <input type="number" class="form-control" id="example-text-input"
                                                        name="mmonth_inc" placeholder="(Mother) Monthly Income"
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 mb-3">
                                                    <label class="form-label" for="example-text-input">Guardian
                                                        Name</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="guardname" placeholder="Guardian Name"
                                                        value="<?php echo $row['guardname']; ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label"
                                                        for="example-text-input">Relationship</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="grelation" placeholder="Relationship"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="gtel_no" placeholder="Telephone Number"
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label" for="example-text-input">Cellphone
                                                        No.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="gcontact" placeholder="Cellphone Number"
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label" for="example-text-input">Email
                                                        Address</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="gemail" placeholder="Email Address"
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control mb-3" id="example-text-input"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label" for="example-text-input">School Last
                                                        Attended</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="last_attend" placeholder="School Last Attended"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="example-text-input">School
                                                        Year</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="sch_year" data-inputmask-alias="datetime"
                                                        data-inputmask-inputformat="yyyy-yyyy" placeholder="School Year"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label" for="example-text-input">School
                                                        Address</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="sch_address" placeholder="School Last Attended"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label" for="example-text-input">Honors &
                                                        Awards</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="honor" placeholder="School Last Attended"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="acad_c" placeholder="Academic Competitions Joined"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="sport_c" placeholder="Sports Competitions Joined"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label" for="example-text-input">School
                                                        Org.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="sch_m" placeholder="Membership in School Organization"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label"
                                                        for="example-text-input">Community/Religous Org.</label>
                                                    <input type="text" class="form-control" id="example-text-input"
                                                        name="comrel_m"
