                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <label class="form-label" for="example-text-input">Place of
                                                            Birth</label>
                                                        <input type="text" class="form-control" id="example-text-input" name="place_birth" placeholder="Place of Birth" value="<?php echo $row['place_birth']; ?>">
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                        <label class="form-label" for="example-text-input">Age</label>
                                                        <input type="text" class="form-control" id="example-text-input" name="age" placeholder="Enter your Age" value="<?php echo $row['age']; ?>">
                                                    </div>
                                                    <div class="col-md-4 mb-3">
