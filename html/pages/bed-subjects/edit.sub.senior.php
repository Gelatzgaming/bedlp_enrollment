                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            WHERE subject_id = '$sen_id'");
                                ...
                                <form action="userData/user.edit.sub.senior.php" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input value="<?php echo $_GET['sen_id']; ?>" type="text" name="sen_id"
                                                hidden>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input"
                                                ...
                                                required value="<?php echo $row['subject_description']; ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="justify-content-end mb-3 mt-3 p-0 float-right">
                                        <?php
                                            if ($strand_n == "ABM") {
                                                ...
                                                echo '<a href=" list.sub.senior.php?ict=' . $strand_n . '&eay=' . $eay . '" class="btn btn-secondary mb-3">';
