                                    ...
                                    <form action="userData/user.edit.sub.senior.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="example-text-input" name="prerequisites" placeholder="Enter Pre-Requisites" required value="<?php echo $row['pre_requisites']; ?>">
                                            </div>
                                            <div class="col-md-4 mb-3">
