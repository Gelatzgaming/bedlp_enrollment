                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            WHERE sy.student_id = '$stud_id' AND ay.academic_year = '$act_acad' AND (sem.semester = '$act_sem' OR sy.semester_id = '0')") or die(mysqli_error($conn));
                                ...
                                <form action="userData/user.edit.enroll.php" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input"
                                                name="studno" placeholder="Student ID"
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-5 mb-3">
                                            ...
                                            <select class="form-select" data-dropdown-css-class="select2-info"
                                                data-placeholder="Select Type" name="stud_type">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" data-dropdown-css-class="select2-info"
                                                data-placeholder="Select Strand" name="strand" id="strand">
