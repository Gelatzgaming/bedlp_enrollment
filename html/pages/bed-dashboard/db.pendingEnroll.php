        ...
        <div class="content">
            <div class="container-fluid pl-5 pr-5 pb-3">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Pending Enrollees</h4>
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['look'])) {
                                            ...
                                            $get_enrolled_stud = mysqli_query($conn, "SELECT *, CONCAT(stud.student_lname, ', ', stud.student_fname, ' ', stud.student_mname) AS fullname 
                                                ...
                                                WHERE (remark = 'Canceled' OR remark = 'Pending') AND ay.academic_year = '$act_acad' AND (sem.semester = '$act_sem' OR sy.semester_id = '0')
