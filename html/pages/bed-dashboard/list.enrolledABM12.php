                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a type="button" class="btn btn-danger text-sm p-2 mb-md-2"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal<?php echo $id ?>"><i
                                                        class="fa fa-trash"></i>
                                                    Delete
                                                </a>
                                            </td>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="../bed-students/userData/user.del.studABM.php?<?php echo 'sy_id=' . $sy_id; ?>"
