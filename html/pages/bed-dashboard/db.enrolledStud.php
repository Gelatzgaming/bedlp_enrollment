        ...
        <div class="content">
            <div class="container-fluid pl-5 pr-5 pb-3">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">List of Enrolled Students</h4>
                            ...
                            <div class="data-tables display">
                                <table id="example" class="table table-striped nowrap" data-bs-toggle="data-table" style="width: 100%;">
