            ...
            <div class="col-md-3 mt-5 mb-3">
                <div class="card">
                    <div class="small-box bg-info">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="dblp.oldStud.php" class="small-box-footer"
                                style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box bg-info">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="dblp.droppedStud.php" class="small-box-footer"
                                style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box bg-info">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="../bedlp-online-enrollment/online.list.php" class="small-box-footer"
                                style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
