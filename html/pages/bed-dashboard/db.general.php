                ...
                <div class="card">
                    <div class="small-box bg-info" style="border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="db.enrolledStud.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
            ...
            <div class="col-md-3 mt-5 mb-3">
                <div class="card">
                    <div class="small-box bg-info" style="border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="db.newStud.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-5 mb-3">
                <div class="card">
                    <div class="small-box bg-info" style="border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="db.oldStud.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-5 mb-3">
                <div class="card">
                    <div class="small-box bg-info" style="border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="db.pendingEnroll.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box bg-info" style="border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="db.droppedStud.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="small-box bg-info" style="border-radius: 15px;">
                        <div class="p-4 d-flex justify-content-between align-items-center">
                            ...
                            <div class="seofct-icon" style="color: white;"><i class="fa fa-globe" style="font-size: 50px;"></i><br><small> Total No.
                                    of</small><br>
                                Online Inquiry</div>
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="../bed-online-enrollment/online.list.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="small-box bg-info" style="border-radius: 15px;">
                        <div class="p-4 d-flex justify-content-between align-items-center">
                            ...
                            <div class="seofct-icon" style="color: white;"><i class="fa fa-user-circle-o" style="font-size: 50px;"></i><br><small> Total No.
                                    of</small><br>
                                Balik Franciscano</div>
                            <?php $stud_count = mysqli_query($conn, "SELECT count(sy_id) AS total_stud FROM tbl_schoolyears WHERE remark = 'Pending' OR remark = 'Approved' AND bf = 'Yes'") or die(mysqli_error($conn));
                            while ($row = mysqli_fetch_array($stud_count)) { ?>
                                <h1 class="mb-5" style="color: white;"><?php echo $row['total_stud']; ?></h1>
                            <?php } ?>
                        </div>
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="db.balikFrancis.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="small-box" style="background-color: maroon; border-radius: 15px;">
                        <div class="p-4 d-flex justify-content-between align-items-center">
                            ...
                            <div class="seofct-icon" style="color: white;"><i class="fa fa-laptop" style="font-size: 50px;"></i><br><small> Total No.
                                    of</small><br>
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledICT11.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: maroon; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledICT12.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: purple; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledHUMSS11.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: purple; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledHUMSS12.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: orange; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledHE11.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: orange; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledHE12.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #095073; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledG10.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #095073; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledG9.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #095073; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledG8.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #095073; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledG7.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #095073; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledG6.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #095073; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledG5.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #095073; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledG4.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #095073; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledG3.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #095073; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledG2.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #095073; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledG1.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #850554; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledKINDER.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #850554; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledPREK.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 mt-2 mb-3">
                <div class="card">
                    <div class="small-box" style="background-color: #850554; border-radius: 15px;">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <a href="list.enrolledNURS.php" class="small-box-footer" style="color: white; margin: 0px; display:block; margin-bottom: 10px;">View
                                Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
