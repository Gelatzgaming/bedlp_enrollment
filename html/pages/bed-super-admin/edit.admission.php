                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body" style="color:black;">
                                ...
                                <form action="userData/user.edit.admission.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    ?>
                                    <input class="form-control" type="text" name="admission_id" value="<?php echo $row['admission_id']; ?>" hidden>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input" name="admission_fname" placeholder="First name" value="<?php echo $row['admission_fname']; ?>" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="example-text-input">Middle name</label>
                                            <input type="text" class="form-control" id="example-text-input" name="admission_mname" placeholder="Middle name" value="<?php echo $row['admission_mname']; ?>" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="example-text-input">Last name</label>
                                            <input type="text" class="form-control" id="example-text-input" name="admission_lname" placeholder="Last name" value="<?php echo $row['admission_lname']; ?>" required>
                                        </div>
