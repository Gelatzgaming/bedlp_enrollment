                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title"> Edit Adviser</h4>
                                    <p class="text-muted font-14 mb-4">Fill up the forms.
                                </div>
                            </div>
                            <div class="card-body" style="color:black;">

                                <form action="userData/user.edit.adviser.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    ?>
                                    <input class="form-control" type="text" name="ad_id" value="<?php echo $row['ad_id']; ?>" hidden>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input" name="firstname" placeholder="First name" value="<?php echo $row['ad_fname']; ?>" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="example-text-input">Middle name</label>
                                            <input type="text" class="form-control" id="example-text-input" name="midname" placeholder="Middle name" value="<?php echo $row['ad_mname']; ?>" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="example-text-input">Last name</label>
                                            <input type="text" class="form-control" id="example-text-input" name="lastname" placeholder="Last name" value="<?php echo $row['ad_lname']; ?>" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-select form-select-md" data-dropdown-css-class="select2-purple" data-placeholder="Select Assigned Department" name="dept">
                                                <option selected value="<?php echo $row['ad_dept'] ?>">
                                                    <?php echo $row['ad_dept'] ?></option>
                                                <?php if ($row['ad_dept'] == 'Pre-Kinder to Grade 6') {
                                                } else {
                                                ?> <option value="Pre-Kinder to Grade 6">Pre-Kinder to Grade 6</option>
                                                <?php
                                                }
                                                ?>

                                                <?php if ($row['ad_dept'] == 'Grade 7 to Grade 10') {
                                                } else {
                                                ?> <option value="Grade 7 to Grade 10">Grade 7 to Grade 10</option> <?php
                                                                                                                }
                                                                                                                    ?>

                                                <?php if ($row['ad_dept'] == 'Grade 11') {
                                                } else {
                                                ?> <option value="Grade 11">Grade 11</option> <?php
                                                                                            }
                                                                                                ?>

                                                <?php if ($row['ad_dept'] == 'Grade 12') {
                                                } else {
                                                ?> <option value="Grade 12">Grade 12</option> <?php
                                                                                            }
                                                                                                ?>
                                    ...
                                    <div class="form-group float-end">
                                        <button class="btn btn-danger" type="submit" name="submit">Edit Adviser</button>
                                    </div>
                                </form>
                            </div>
                        </div>
