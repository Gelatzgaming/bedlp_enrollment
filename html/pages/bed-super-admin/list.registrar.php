                                    ...
                                    <table id="user-list-table" class="table table-hover responsive nowrap" role="grid"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-center"><img
                                                        class="bg-soft-primary rounded img-fluid avatar-40 me-3"
                                                        src="../../assets/images/shapes/03.png" alt="profile"></td>
                                                <td>Dan Druff</td>
                                            ...
                                            <tr>
                                                <td class="text-center"><img
                                                        class="bg-soft-primary rounded img-fluid avatar-40 me-3"
                                                        src="../../assets/images/shapes/04.png" alt="profile"></td>
                                                <td>Hans Olo</td>
                                            ...
                                            <tr>
                                                <td class="text-center"><img
                                                        class="bg-soft-primary rounded img-fluid avatar-40 me-3"
                                                        src="../../assets/images/shapes/05.png" alt="profile"></td>
                                                <td>Lynn Guini</td>
                                            ...
                                            <tr>
                                                <td class="text-center"><img
                                                        class="bg-soft-primary rounded img-fluid avatar-40 me-3"
                                                        src="../../assets/images/shapes/06.png" alt="profile"></td>
                                                <td>Eric Shun</td>
