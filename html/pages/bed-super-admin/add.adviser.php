                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title"> Add Adviser</h4>
                                ...
                                <form action="userData/user.add.adviser.php" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input"
                                                name="midname" placeholder="Middle name" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input"
                                                aria-label="Username" name="username" placeholder="Username" required>
                                        </div>
