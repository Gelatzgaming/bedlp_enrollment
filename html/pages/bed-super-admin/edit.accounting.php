                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input"
                                                name="accounting_fname" placeholder="First name"
                                                value="<?php echo $row['accounting_fname']; ?>" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="example-text-input">Middle name</label>
                                            <input type="text" class="form-control" id="example-text-input"
                                                name="accounting_mname" placeholder="Middle name"
                                                value="<?php echo $row['accounting_mname']; ?>" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="example-text-input">Last name</label>
                                            <input type="text" class="form-control" id="example-text-input"
                                                name="accounting_lname" placeholder="Last name"
                                                value="<?php echo $row['accounting_lname']; ?>" required>
                                        </div>
