...
$pdf->Image('../../assets/images/auth/logo.jpg', 35, 5, 20, 20);
$pdf->Image('../../assets/images/auth/logo1.jpg', 169, 5, 20, 20);
// text color
...
while ($row = mysqli_fetch_array($get_stud)) {
    ...
    $pdf->SetFont('Arial', '', 8);
    $pdf->Cell(39, 6, 'Complete Address:', 1, 0, 'C');
    $pdf->Cell(49, 6, '', 1, 0, 'C');
    $pdf->Cell(55, 6, '', 1, 0, 'C');
    $pdf->SetFont('Arial', '', 8);
    $fontsize = 8;
    ...
    $pdf->Cell(60, 6, $row['gaddress'], 1, 1, 'C');

    $pdf->Ln(1);
    $pdf->SetFont('Arial', 'B', 9);
    $pdf->Cell(203, 5, 'LIST OF SUBJECTS', 1, 1, 'C');

    $pdf->SetFont('Arial', 'B', 8);
    $pdf->Cell(101.5, 5, 'First Semester', 1, 0, 'C');
    $pdf->Cell(101.5, 5, 'Second Semester', 1, 1, 'C');

    $pdf->Cell(25, 5, 'Subject Code', 'T,L,B', 0, 'C');
    $pdf->Cell(76.5, 5, 'Subjects', 'T,L,B', 0, 'C');
    $pdf->Cell(25, 5, 'Subject Code', 'T,L,B', 0, 'C');
    $pdf->Cell(76.5, 5, 'Subjects', 'T,L,R,B', 0, 'C');
    $pdf->Cell(0, 4, '', 0, 1);
    ...
    $pdf->Image('../../assets/images/auth/footer1.jpg', 60, 260, 150, 10);

    $pdf->Image('../../assets/images/auth/footer2.jpg', 5, 260, 60, 10);
}
