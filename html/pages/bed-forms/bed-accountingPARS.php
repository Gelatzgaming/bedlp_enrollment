...
$pdf->Image('../../assets/images/auth/logo.jpg', 20, 9, 15, 15);
$pdf->Image('../../assets/images/auth/logo1.jpg', 130, 9, 15, 15);

$pdf->SetTextColor(255, 0, 0);

$pdf->SetFont('Arial', 'B', 11);

$pdf->Cell(155, 5, 'Saint Francis of Assisi College Las '. utf8_decode('Piñas ') . 'Campus', 0, 1, 'C');
