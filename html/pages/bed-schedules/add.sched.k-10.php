                        ...
                        <div class="card">
                            ...
                            WHERE sub.subject_id = '$sub_id'") or die(mysqli_error($conn));
                                ...
                                ?>
                                    ...
                                    <form action="userData/user.add.sched.k-10.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="example-text-input" name="subj_code" placeholder="Enter Subject Code" readonly value="<?php echo $row['subject_code']; ?>">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label" for="example-text-input">Description</label>
                                                <input type="text" class="form-control" id="example-text-input" name="subj_description" placeholder="Enter Subject Description" readonly value="<?php echo $row['subject_description']; ?>">
                                            </div>
                                        </div>
