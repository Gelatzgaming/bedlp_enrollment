                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body" style="color:black;">
                                ...
                                <form action="userData/user.admitonline.php" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input" name="age"
                                                placeholder="Middle name" value="<?php echo $row['age']; ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input" name="email"
